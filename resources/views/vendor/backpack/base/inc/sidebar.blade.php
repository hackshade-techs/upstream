      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <li><a href="{{ backpack_url('slide') }}"><i class="fa fa-picture-o"></i> <span>Sliders</span></a></li>
            <li><a href="{{ backpack_url('gallery') }}"><i class="fa fa-image"></i> <span>Gallery</span></a></li>
            </ul>
          </li>

          <li><a href="{{ backpack_url('newsletter') }}"><i class="fa fa-envelope-o"></i> <span>Newsletter</span></a></li>

          <li><a href="{{ backpack_url('quote') }}"><i class="fa fa-cart-plus"></i> <span>Quotes</span></a></li>

          <li><a href="{{ backpack_url('contact') }}"><i class="fa fa-comments"></i> <span>Contacts</span></a></li>

          <li><a href="{{ backpack_url('testmonial') }}"><i class="fa fa-hand-paper-o"></i> <span>Testmonials</span></a></li>
          ...
          <li class="treeview">
            ...
            <li><a href="{{ backpack_url('venue') }}"><i class="fa fa-map"></i> <span>Venues</span></a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{ backpack_url('comment') }}"><i class="fa fa-comment-o"></i> <span>Comments</span></a></li>
              </ul>
          </li>
